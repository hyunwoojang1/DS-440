...
# WRDS requires institutional subscription + Duo 2FA — fundamental scores skipped if absent
WRDS_USERNAME: str = _get_optional("WRDS_USERNAME", "")
# WRDS password (same as wrds.wharton.upenn.edu login) — used once to trigger Duo push; pgpass is then refreshed for ~2 weeks
